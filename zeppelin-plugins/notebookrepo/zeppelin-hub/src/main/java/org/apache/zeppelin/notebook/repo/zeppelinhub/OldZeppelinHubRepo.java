...
public class OldZeppelinHubRepo implements OldNotebookRepoWithVersionControl {
  ...
  private String getZeppelinHubWsUri(URI api) throws URISyntaxException {
    ...
    if (scheme == null) {
      LOG.info("{} is not a valid zeppelinhub server address. proceed with default address import com.google.common.collect.Lists;{}",
  ...
  public Revision checkpoint(String noteId, String checkpointMsg, AuthenticationInfo subject)
    ...
    String endpoint = String.join(File.separator, noteId, "checkpoint");
  ...
  public Note get(String noteId, String revId, AuthenticationInfo subject) throws IOException {
    ...
    String endpoint = String.join(File.separator, noteId, "checkpoint", revId);
    String token = getUserToken(subject.getUser());
